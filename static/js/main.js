...
function onChatMessage(data) {
    ...
    if (data.type == 'chat_message') {
        ...
        chatLogElement.innerHTML += '<p class="mt-2">The admin/agent has joined chat!</p>'
...
async function joinChatRoom() {
    ...
    chatSocket = new WebSocket(`ws://${window.location.host}/ws/chat/${chatRoomUuid}/`) // According to routing.py
